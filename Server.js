...
mongoose.connect('mongodb+srv://Akshat_Tiwari_1404:Akshat_1404@scheduling.2wuji.mongodb.net/schedulesDB?retryWrites=true&w=majority').then(() => console.log('MongoDB connected')).catch(err => console.error('MongoDB connection error:', err));
